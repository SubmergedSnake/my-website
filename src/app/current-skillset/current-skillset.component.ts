...
export class CurrentSkillsetComponent {
    ...
    nonsense = 'no changes found, aye?';
     ...
     skills: Skill[] = [
                            ...
                            { url:'assets/img/spring.png' , explanation:'We used the Spring framework to speed up Java development in one of our school projects. You can take a look at it on GitHub: https://github.com/ledeveo/hoptimus', alt:'Spring' },
                            { url:'assets/mysql.png' , explanation:'MySql is what we`ve been using with our databases. Basic skills in this department.', alt:'MySql' },
